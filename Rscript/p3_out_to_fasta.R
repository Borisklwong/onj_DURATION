...
# vcf_dir = "/home/users/allstaff/wong.b/onj_DURATION/processing/BGI_DURATION_processing/before_trimming"

#for designing primers flanking to the breakpoints
p3_out_file = paste0(file_path,"/gripss/",sample_name,"_p3_out")

load(paste0(vcf_dir,"/",sample_name,"_vcf_to_p3_df_new"))
...
load(paste0(vcf_dir,"/",sample_name,"_vcf_to_p3_df_overlap_new"))
