...
argv = parse_args(argp, argv=c("--input", "C:/Users/wong/Documents/DURATION/WGS_data/CL100112751_L02_VCF/CL100112751_L02_sort_mark.sv.vcf", "--output", "C:/Users/wong/Documents/DURATION/WGS_data/CL100112751_L02_VCF/CL100112751_L02_out.vcf", "-f", "C:/Users/wong/Documents/DURATION/WGS_data/FR07886867_vcf/CL100112751_L02_full.vcf", "-p", "C:/Users/wong/Documents/DURATION/Hartwig/HMF-Pipeline-Resources/GRIDSS_PON_3792v1", "--scriptdir", "C:/Users/wong/Documents/GitHub/scripts/gridss", "--gc"))
...
befiltered = gridss_breakend_filter(begr, full_vcf, pon_dir=argv$pondir)
...
#########################################
##Sample CL100112751_L02_out, after PON normal subtraction
CL100112751_L02_out = file.path("~","DURATION","WGS_data","CL100112751_L02_VCF","CL100112751_L02_out.vcf") 
CL100112751_L02_out_run = VariantAnnotation::readVcf(CL100112751_L02_out)
CL100112751_L02_out_run_gr = breakpointRanges(CL100112751_L02_out_run)

#Pair the 2 paired reads into 1 result, faster down stream analysis
CL100112751_L02_out_pairgr = breakpointgr2pairs(CL100112751_L02_out_run_gr)
write.csv(CL100112751_L02_out_pairgr, "CL100112751_L02_out_pairgr.csv")

CL100112751_L02_out_pairgr 

new.pairs <- breakpointgr2pairs(CL100112751_L02_out_run_gr)

#############################################


data.frame(chr=seqnames(full_vcf [ bpgr$vcfId[bpfiltered==""]  ]  ), q=geno(full_vcf[bpgr$vcfId[bpfiltered==""]])$QUAL[,1]) %>% 
  ggplot() + aes(x=q, fill=chr) + geom_histogram(bins=100) + scale_x_log10()

####################################################
##
CL100112751_L02_vcf = file.path("C:/Users/wong/Documents/DURATION/WGS_data/CL100112751_L02_VCF/CL100112751_L02_sort_mark.sv.vcf") 
CL100112751_L02_vcf_gr = breakpointRanges(VariantAnnotation::readVcf(CL100112751_L02_vcf))



##Ploting circos plot
#change the format of the result from Granges into bedpe
CL100112751_L02_vcf_gr_bedpe = breakpointgr2bedpe(CL100112751_L02_vcf_gr)
#Only keep the top 10 results with highest GRIDSS score
CL100112751_L02_vcf_gr_bedpe_top10 = CL100112751_L02_vcf_gr_bedpe%>% filter(score > sort(score, decreasing = TRUE)[11])
#Only keep the top 100 results with highest GRIDSS score
CL100112751_L02_vcf_gr_bedpe_top100 = CL100112751_L02_vcf_gr_bedpe%>% filter(score > sort(score, decreasing = TRUE)[101])
#creat an empty circos plot
circos.initializeWithIdeogram()
#plot the top 10 gridss result into the circos plot
circos.genomicLink(CL100112751_L02_vcf_gr_bedpe_top10[,1:3], CL100112751_L02_vcf_gr_bedpe_top10[,4:6])
#plot the top 10 gridss result into the circos plot
circos.genomicLink(CL100112751_L02_vcf_gr_bedpe_top100[,1:3], CL100112751_L02_vcf_gr_bedpe_top100[,4:6])
head(CL100112751_L02_vcf_gr_bedpe_top100, 11)
CL100112751_L02_vcf_gr_bedpe_sort = sort(CL100112751_L02_vcf_gr_bedpe, score, decreasing = TRUE)
