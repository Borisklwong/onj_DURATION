...
argv = parse_args(argp, argv=c(
  "--input", "/stornext/Home/data/allstaff/w/wong.b/R/DURATION_Gridss_result/18_TGEG_528_result/18_TGEG_528_merged_mark.sv.vcf",
  "--output", "/stornext/Home/data/allstaff/w/wong.b/R/DURATION_Gridss_result/18_TGEG_528_result/18_TGEG_528_merged_mark_out.sv.vcf",
  "--pairoutput", "/stornext/Home/data/allstaff/w/wong.b/R/DURATION_Gridss_result/18_TGEG_528_result/18_TGEG_528_merged_mark_out_paired.sv.bedpe",
  "--pairoutput_details", "/stornext/Home/data/allstaff/w/wong.b/R/DURATION_Gridss_result/18_TGEG_528_result/18_TGEG_528_merged_mark_out_paired.csv",
  "-f", "/stornext/Home/data/allstaff/w/wong.b/R/DURATION_Gridss_result/18_TGEG_528_result/18_TGEG_528_merged_mark_full.sv.vcf",
